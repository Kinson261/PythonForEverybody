...
counter = 0                                 #init
for line in fhand:
    line.rstrip()                           #removing whitespace at the end of each line
    if line.startswith('From '):            #parsing
        decomp = line.split()               #decomposing line
        print(decomp[1])                    #Second word index = 1
        counter = counter + 1               #increment


print('\nThere were ', counter, ' lines in the file with From as the first word.')
